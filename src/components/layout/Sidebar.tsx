...
import { X, ChevronDown, ChevronRight, Check, BookOpen, Code } from "lucide-react";
    ...
    <div className="mb-1">
      <button
        ...
        className={cn(
          ...
          hasActiveChild ? "bg-yellow-500/10 text-yellow-600 dark:text-yellow-400" : "text-foreground hover:bg-muted"
        )}
      >
      ...
      >
        <div className="flex items-center justify-between px-4 h-16 border-b border-border shrink-0">
          <div onClick={() => navigate("/")} className="flex items-center gap-3 cursor-pointer">
            <div className="w-9 h-9 rounded-xl bg-[#f7df1e] flex items-center justify-center">
              <Code className="w-5 h-5 text-black" />
            </div>
            <div>
              <div className="font-bold text-sm leading-tight">JS Guide</div>
              <div className="text-[10px] text-muted-foreground font-normal">JavaScript Completo</div>
            </div>
          </div>
          <button
            onClick={() => setIsOpen(false)}
        ...
        <div className="px-4 py-4 border-b border-border">
          <div className="flex items-center justify-between text-xs mb-2">
            ...
            <span className="font-bold text-yellow-500">{stats.percentage}%</span>
          </div>
